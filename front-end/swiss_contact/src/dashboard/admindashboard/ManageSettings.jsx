    ...
    return (
        <div className="p-6 max-w-4xl mx-auto bg-white rounded-xl shadow-md space-y-4">
            ...
            <div className="flex space-x-8">
                {/* Change Profile Form */}
                <form onSubmit={handleSubmitProfile} className="space-y-4 flex-1">
                    <h3 className="text-lg font-semibold">Change Profile</h3>
                    <input
                        type="text"
                        name="Names"
                    ...
                    <input
                        ...
                        className="w-full p-2 border border-gray-300 rounded"
                    />
                    <button type="submit" className="w-full p-2 bg-gray-500 text-white">Save Changes</button>
                </form>

                {/* Change Password Form */}
                <form onSubmit={handleSubmitPassword} className="space-y-4 flex-1">
                    <h3 className="text-lg font-semibold">Change Password</h3>
                    <input
                        type="password"
                        name="currentpassword"
                    ...
                    <input
                        ...
                        className="w-full p-2 border border-gray-300 rounded"
                    />
                    <button type="submit" className="w-full p-2 bg-gray-500 text-white rounded">Save Changes</button>
                </form>
            </div>
